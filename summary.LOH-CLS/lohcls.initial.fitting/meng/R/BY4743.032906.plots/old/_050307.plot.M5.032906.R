...
###################overlay s, m, Pb, Rb
 pdf("050707.032906M5.m.Rb.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
...
##################################
 pdf("050707.032906M5.b0.5.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
 ...
 ##################################
 pdf("050707.032906M5.L.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
 ...
 ##################################
 pdf("050707.032906M5.Fb.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
