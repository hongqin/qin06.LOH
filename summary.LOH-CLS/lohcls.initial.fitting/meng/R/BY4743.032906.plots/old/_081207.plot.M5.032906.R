...
##################################
 pdf("080707.032906M5.b0.5log.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
 ...
 ylim = c(1E-5, 0.1)
 plot( out$R0.5 ~ out$t, col="green", xlab="t (days)",ylab="Normalized half-black percentage", type='l',lty=2, ylim=ylim,xlim=xlim,log='y' );
 # title (file);                           ############change here
