...
###################overlay s, Pb, 
 pdf("050707.030906YPS163.s.Pb.pdf", width=6, height=6)
...
##################################
 pdf("072507.030906YPS163.Fb.F0.5.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
 
 e.fb = tb.m$sd.b; 
 #e.fb[6] = e.fb[6]*0.8;
 tb.m$black[1] = sum(tb.m$black[2:3] ) /2.5   ############# only for yps163
 ...
 legend( 5.5 , 0.8  ,labels, col=cols, lty=ltypes, pch=pch);
 text( 8, 0.85, exp.id); 
