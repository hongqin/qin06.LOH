...
###################overlay s, m, Pb, Rb
 pdf("010708.032906M5.r.m.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
...
##################################
 pdf("010708.032906M5.b0.5log.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
 ...
 ##################################
 pdf("010708.032906M5.L.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
...
##################################
 pdf("010708.032906M5.Fb.F0.5.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
