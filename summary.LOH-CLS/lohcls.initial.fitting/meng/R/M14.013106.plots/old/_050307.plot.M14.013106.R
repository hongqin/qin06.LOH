...
###################overlay s, Pb, 
 pdf("050707.013106M14.s.Pb.pdf", width=6, height=6)
...
###################overlay s, m, Pb, Rb
 pdf("050707.013106M14.m.Rb.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
...
##################################
 pdf("050707.013106M14.b0.5.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
 ...
 ##################################
 pdf("050707.013106M14.L.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
 ...
 ##################################
 pdf("050707.013106M14.Fb.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
