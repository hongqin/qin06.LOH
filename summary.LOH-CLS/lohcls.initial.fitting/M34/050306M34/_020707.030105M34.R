...
ww = c(20,17,17,       5,   10,    10,       6,      10,   20,  10,     5,   5)
TT = c(6,  7,   10,   7,    6,        4,       6,     5,   5,   10,     4,   4);

parameters = c("strain", "Tc","wc", "Tmmax","Tg", "wg", "Tbmax","Td", "wd", "Tdmax","b.max", "b.min", "b0", "half.0.raw", "TLmax");
...
######## calclulate T_g and w_g using Pb
 ...
 write.table(out2, "estimations.050306M34.020707.csv", row.names=F, quote=F, sep="\t");
