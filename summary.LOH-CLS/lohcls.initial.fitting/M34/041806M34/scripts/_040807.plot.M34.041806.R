...
###################overlay s, Pb, 
 pdf("050307.041806M34.s.Pb.pdf", width=8, height=8)
...
###################overlay s, m, Pb, Rb
 pdf("050307.041806M34.m.Rb.pdf", width=8, height=8)
 par(mar=c(5,4,4,4)+0.1);
...
##################################
 pdf("050307.041806M34.b0.5.pdf", width=8, height=8)
 par(mar=c(5,4,4,4)+0.1);
 ...
 ##################################
 pdf("050307.041806M34.L.pdf", width=8, height=8)
 par(mar=c(5,4,4,4)+0.1);
 ...
 ##################################
 pdf("050307.041806M34.Fb.pdf", width=8, height=8)
 par(mar=c(5,4,4,4)+0.1);
