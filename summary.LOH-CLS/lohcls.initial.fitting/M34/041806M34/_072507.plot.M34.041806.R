...
###################overlay s, Pb, 
 pdf("050707.041806M34.s.Pb.pdf", width=6, height=6)
...
###################overlay s, m, Pb, Rb
 pdf("050707.041806M34.m.Rb.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
...
##################################
 pdf("050707.041806M34.b0.5.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
 ...
 ##################################
 pdf("050707.041806M34.L.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
 ...
 ##################################
 pdf("050707.041806M34.Fb.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
 ...
 ##################################
 pdf("072507.041806M34.Fb.F0.5.pdf", width=6, height=6)
 par(mar=c(5,4,4,4)+0.1);
