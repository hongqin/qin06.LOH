...
files = c( "060306.rad52DD1.tab", "060306.rad52DD2.tab");
...
pdf( paste("110206", "060306rad52DD", "pdf", sep="."), width=8, height=8 ); 
...
# ss =1; 
 ...
 tb = read.table(files[ss], header=T, sep="\t", fill=T);
...
######## calclulate T_g and w_g using Pb
 ...
 write.table(out2, paste("estimations","060306.rad52DD","csv",sep="."), row.names=F, quote=F, sep="\t");
