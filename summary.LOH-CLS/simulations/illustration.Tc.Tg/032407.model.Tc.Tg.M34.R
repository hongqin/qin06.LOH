### 032507 model Tc Tg for publication
...
######### end of functions
 ...
 pdf( paste("032407", "modelTgTc", "pdf", sep="."), width=8, height=8 ); 
 ...
 lines( out$Pb ~ out$t, col="black", lty=3);
 
 labels = c("Viability (s)", "Genome integrity (g)", "Full-blacks (b)");
 ltypes = c(1,1, 3);
 legend( (max(out$t)*0.7 ), 0.95, labels, col=c("blue", "red","black" ), lty = ltypes);
